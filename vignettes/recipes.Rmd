...
vignette: >
  %\VignetteIndexEntry{Hands-on workshop recipes}
...
<li>You can remind yourself of the list of parameter names and values available for each panel class using the `str()` function on any instance of a panel object, e.g. `str(ReducedDimensionPlot())`.</li>
