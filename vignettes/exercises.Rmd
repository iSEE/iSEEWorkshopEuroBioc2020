...
This vignette consists of a series of (independent) hands-on exercises, aimed at exploring the capabilities of `r Biocpkg("iSEE")` both interactively and programmatically.
Each exercise consists of a short task and a screen shot of the desired appearance of the app instance that should be created. 
For each exercise, we provide a set of hints, as well as detailed instructions on how to solve the exercise both interactively (by clicking in the app) and programmatically (by directly setting up and launching the desired app instance).
...
Before starting with the exercises, we need to load the required packages and the demo data set.
...
# Exercise 5: Visual parameters configuration - coloring reduced dimension representations by cell annotation
...
# Exercise 6: Visual parameters configuration - coloring reduced dimension representations by gene expression
...
```{r, echo=FALSE}
SCREENSHOT("screenshots/exercise_06.png", delay=20)
```

# Exercise 7: Visual parameters configuration - changing the size and opacity of points
...
```{r, echo=FALSE}
SCREENSHOT("screenshots/exercise_07.png", delay=20)
```

# Exercise 8: Selection configuration
...
```{r, echo=FALSE}
SCREENSHOT("screenshots/exercise_08.png", delay=20)
```

# Exercise 9: Verifying the cell type identity of clusters
...
```{r, echo=FALSE}
SCREENSHOT("screenshots/exercise_09.png", delay=20)
```

# Exercise 10: Using modes from `iSEEu`
...
```{r, echo=FALSE}
SCREENSHOT("screenshots/exercise_10.png", delay=20)
```
